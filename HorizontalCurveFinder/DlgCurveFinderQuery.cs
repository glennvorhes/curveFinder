...
namespace HorizontalCurveFinder
{
    public partial class DlgCurveFinderQuery : Form
    {
        ...
        private CurveCollection m_AllCurves = new CurveCollection();
        private CurveCollection m_AllCurveAreas = new CurveCollection();
        private ClassHozCurve m_pCurrHozCurve = null;
        private ClassHozCurve m_pCurrCurveArea = null;
        ...
        protected AboveBelowLine PointAboveOrBelowtheLine(CStraightLine line, IPoint ptPoint)
        {
        ...
        {
            CStraightLine theline = new CStraightLine(ptLineFrom, ptLineTo);
        ...
        public IFeatureClass CreateCurveFeatureClass(IFeatureDataset featureDataset, String strNameOfFeatureClass)
        {
        ...
        public IFeatureClass CreateCurveAreaFeatureClass(IFeatureDataset featureDataset, String strNameOfFeatureClass)
        {
        ...
        private void btIdentifyCurveAreas_Click(object sender, EventArgs e)
        {
            ...
            while (pFeature != null)
            {
                ...
                */
                ...
                while (currSegment != null)
                {
                    ...
                    {
                        currIowaSeg.dDeflcAngle = GetAngleBetweenTwoLines(currIowaSeg.preSeg.ptFrom, currIowaSeg.ptFrom, currIowaSeg.ptTo);
                        currIowaSeg.SideFromPreSeg = PointOnSideOfALine(currIowaSeg.preSeg.ptFrom, currIowaSeg.ptFrom, currIowaSeg.ptTo);
                        currIowaSeg.preSeg = prevIowaSeg;
                    }
                ...
                SideOfLine [] sideIowaSeg = new SideOfLine [nIowaSegCount];
            ...
            IFeatureClass pCurveAreaFC = CreateCurveAreaFeatureClass(pFeatureDS, strCurveAreaLayerName);
